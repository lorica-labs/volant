---
title: "`become` runs a second agent under `sudo`"
description: "Decision record 0004."
sidebar:
  label: "0004 · become under sudo"
  order: 4
---

| Status | Date |
|---|---|
| accepted; the bound on live connections is superseded by [ADR 0005](/decisions/0005-fork-permits-span-host-local-batches/) | 2026-09-09 |
